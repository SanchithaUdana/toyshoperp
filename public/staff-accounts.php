...
<body>
    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-md-12 grid-margin">
          ...
          <h3 class="font-weight-bold">Staff Accounts</h3>
        </div>
      </div>
      </div>
      </div>
      ...
      <div class="row mb-3">
        <div class="col-md-12">
          <button class="btn btn-success" data-toggle="modal" data-target="#addStaffModal">Add</button>
        </div>
      </div>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editStaffModal">Edit</button>
                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteStaffModal">Delete</button>
                  </td>
                </tr>
  ...
  <!-- End Delete Staff Confirmation Modal -->
